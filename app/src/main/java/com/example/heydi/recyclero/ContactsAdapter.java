package com.example.heydi.recyclero;
        ...
        public MyViewHolder(View view){
            ...
            view.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View view){
                    //enviar contacto seleccionado en devolución de llamada
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if(charString.isEmpty()){
                    ...
                    for(Contact row : contactList){
                        //condición de coincidencia de nombre. Esto podría diferir dependiendo de su

                        //Aquí estamos buscando nombre o número de teléfono que coincida
                        if
